<template>
  <div>
    <el-row :gutter="20">
      <el-col>
        <h1 class="heading" align="left">COINCAP-DASHBOARD</h1>
      </el-col>
    </el-row>
    <el-row :gutter="20">
      <el-col :span="12">
        <selector :list="fullExchangesList" title="Select EXCHANGE" type="selectedExchange" />
      </el-col>
      <el-col :span="12">
        <selector :list="marketsList" title="Select MARKET" type="selectedMarket" />
      </el-col>
    </el-row>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...mapState(["fullExchangesList", "selectedExchange"]),
    ...mapGetters([
      // 'exchangesList',
      "marketsList"
    ])
  ...
  methods: {
    ...mapMutations([SET_EXCHANGES_LIST, SET_MARKETS_LIST, SET_SELECTED_ITEM]),
    loadEchanges() {
      this.$http
